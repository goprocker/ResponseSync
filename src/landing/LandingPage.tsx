    ...
    <div className="min-h-screen bg-[#050507] text-[#e0e0e6] font-sans selection:bg-brand selection:text-white overflow-x-hidden">
      ...
      <header className="fixed inset-x-0 top-3 z-50 flex justify-center px-4 transition-all duration-300 sm:top-5">
        <div className="flex w-full max-w-5xl items-center justify-between rounded-full border border-white/10 bg-white/5 px-2 py-2 pl-6 backdrop-blur-xl transition-all duration-300">
          ...
          {/* CTA Group - Direct View Launchers */}
          <div className="flex items-center gap-1.5 sm:gap-2">
            <button 
              onClick={() => onLaunchDashboard('authority', 'twin_map')}
              className="rounded-full border border-brand/50 bg-brand/10 hover:bg-brand/20 px-3 py-1.5 text-[11px] font-bold uppercase tracking-wider text-brand transition-all cursor-pointer hidden sm:flex items-center gap-1"
            >
              <span>🏛️ Govt Mode</span>
            </button>

            <button 
              onClick={() => onLaunchDashboard('citizen', 'twin_map')}
              className="rounded-full border border-blue-500/50 bg-blue-500/10 hover:bg-blue-500/20 px-3 py-1.5 text-[11px] font-bold uppercase tracking-wider text-blue-400 transition-all cursor-pointer hidden sm:flex items-center gap-1"
            >
            ...
            <a 
              href="#demo"
              className="group inline-flex items-center gap-1 rounded-full bg-brand py-1.5 pl-3.5 pr-2 text-[11px] font-bold uppercase tracking-wider text-white transition-colors hover:bg-brand-deep"
            >
              Book demo
              <span className="grid h-4 w-4 place-items-center rounded-full bg-white/10 transition-transform duration-300 group-hover:translate-x-0.5 group-hover:-translate-y-0.5">
      ...
      <div className={`fixed inset-x-0 top-20 z-40 mx-4 origin-top rounded-3xl border border-white/10 bg-[#0e0e14]/95 p-4 backdrop-blur-xl transition-all duration-300 md:hidden ${
        ...
        <nav className="flex flex-col gap-1.5">
          <div className="p-2 border-b border-white/10 mb-1">
            <p className="text-[10px] font-mono text-neutral-400 uppercase tracking-widest mb-2">Select Portal Mode</p>
            <div className="grid grid-cols-2 gap-2">
              <button 
                onClick={() => { setMobileMenuOpen(false); onLaunchDashboard('authority', 'twin_map'); }}
                className="px-3 py-2 bg-brand/20 border border-brand/50 text-brand text-xs font-bold uppercase rounded-xl text-center"
              >
                🏛️ Govt Mode
              </button>
              <button 
                onClick={() => { setMobileMenuOpen(false); onLaunchDashboard('citizen', 'twin_map'); }}
                className="px-3 py-2 bg-blue-500/20 border border-blue-500/50 text-blue-400 text-xs font-bold uppercase rounded-xl text-center"
              >
                👤 Citizen Mode
              </button>
            </div>
          </div>
          <a onClick={() => setMobileMenuOpen(false)} className="flex items-center justify-between rounded-2xl px-4 py-2.5 text-sm font-bold uppercase tracking-wider text-white hover:bg-white/5" href="#features">
            Features <ArrowUpRight className="h-4 w-4 text-[#888]" />
          </a>
          <a onClick={() => setMobileMenuOpen(false)} className="flex items-center justify-between rounded-2xl px-4 py-2.5 text-sm font-bold uppercase tracking-wider text-white hover:bg-white/5" href="#whoweserve">
            Who we serve <ArrowUpRight className="h-4 w-4 text-[#888]" />
          </a>
          <a onClick={() => setMobileMenuOpen(false)} className="flex items-center justify-between rounded-2xl px-4 py-2.5 text-sm font-bold uppercase tracking-wider text-white hover:bg-white/5" href="#demo">
        ...
        <section className="relative overflow-hidden pt-10 pb-20 lg:pt-16 lg:pb-28">
          <div className="mx-auto grid max-w-7xl items-center gap-12 px-4 sm:px-6 lg:grid-cols-[1.1fr_1fr] lg:gap-16 lg:px-8">
            ...
            <div className="flex flex-col items-start text-left">
              ...
              {/* SELECT OPERATIONAL VIEW CARDS IN HERO */}
              <div className="mt-8 w-full max-w-xl space-y-3">
                <div className="flex items-center justify-between">
                  <span className="mono text-[10px] uppercase tracking-[0.2em] text-brand font-bold">
                    ⚡ Select Operational Portal to Launch:
                  </span>
                </div>

                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                  {/* Government View Card */}
                  <button 
                    onClick={() => onLaunchDashboard('authority', 'twin_map')}
                    className="group relative flex flex-col justify-between p-4 bg-[#0e0e14] hover:bg-brand/10 border border-brand/40 hover:border-brand text-left transition-all cursor-pointer rounded-2xl shadow-xl overflow-hidden"
                  >
                    <div className="space-y-1.5">
                      <div className="flex items-center justify-between">
                        <span className="px-2.5 py-0.5 rounded-full bg-brand/20 text-brand font-bold text-[10px] font-mono tracking-wide uppercase border border-brand/30">
                          🏛️ Govt Mode
                        </span>
                        <ArrowUpRight className="w-4 h-4 text-brand group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform" />
                      </div>
                      <div className="text-sm font-bold text-white uppercase tracking-tight font-sans">
                        Government Command HQ
                      </div>
                      <p className="text-[11px] text-neutral-400 font-sans leading-relaxed">
                        Full access: AI Agent orchestrator, dispatch engine, flood simulations & analytics.
                      </p>
                    </div>
                    <div className="mt-3 pt-2.5 border-t border-white/10 flex items-center justify-between text-[10px] font-mono text-brand font-bold">
                      <span>COMMAND OS</span>
                  ...
                  <button 
                    onClick={() => onLaunchDashboard('citizen', 'twin_map')}
                    className="group relative flex flex-col justify-between p-4 bg-[#0e0e14] hover:bg-blue-500/10 border border-blue-500/40 hover:border-blue-400 text-left transition-all cursor-pointer rounded-2xl shadow-xl overflow-hidden"
                  >
                    <div className="space-y-1.5">
                      <div className="flex items-center justify-between">
                        <span className="px-2.5 py-0.5 rounded-full bg-blue-500/20 text-blue-300 font-bold text-[10px] font-mono tracking-wide uppercase border border-blue-500/30">
                          👤 Citizen Mode
                        </span>
                    ...
                    <div className="mt-3 pt-2.5 border-t border-white/10 flex items-center justify-between text-[10px] font-mono text-blue-400 font-bold">
              ...
              <div className="relative grid gap-12 lg:grid-cols-[1.4fr_1fr] lg:items-center">
                <div className="text-left">
                  ...
                  <div className="mt-8 flex flex-wrap gap-3">
                    <button 
                      onClick={() => onLaunchDashboard('authority', 'twin_map')}
                      className="group inline-flex items-center gap-2 rounded-full bg-brand py-3 pl-5 pr-3 text-xs font-bold uppercase tracking-wider text-white transition-all hover:bg-brand-deep cursor-pointer"
                    >
                      <span>🏛️ Govt Mode</span>
                      <span className="grid h-6 w-6 place-items-center rounded-full bg-white/10 transition-transform group-hover:translate-x-0.5">
                        <ArrowUpRight className="h-3 w-3" />
                      </span>
                    </button>
                    <button 
                      onClick={() => onLaunchDashboard('citizen', 'twin_map')}
                      className="group inline-flex items-center gap-2 rounded-full bg-blue-600/80 border border-blue-400/50 py-3 pl-5 pr-3 text-xs font-bold uppercase tracking-wider text-white transition-all hover:bg-blue-600 cursor-pointer"
                    >
                      <span>👤 Citizen Mode</span>
                      <span className="grid h-6 w-6 place-items-center rounded-full bg-white/10 transition-transform group-hover:translate-x-0.5">
                        <ArrowUpRight className="h-3 w-3" />
          ...
          <div className="grid gap-12 sm:grid-cols-2 lg:grid-cols-[1.5fr_1fr_1fr_1fr]">
            <div className="flex flex-col items-start text-left">
              ...
              <div className="mt-7 flex flex-wrap gap-2">
                <button
                  onClick={() => onLaunchDashboard('authority', 'twin_map')} 
                  className="group inline-flex items-center gap-1.5 rounded-full bg-brand py-2 pl-4 pr-3 text-xs font-bold uppercase tracking-wider text-white transition-colors hover:bg-brand-deep cursor-pointer"
                >
                  🏛️ Govt Mode
                ...
                <button
                  onClick={() => onLaunchDashboard('citizen', 'twin_map')} 
                  className="group inline-flex items-center gap-1.5 rounded-full bg-blue-500/20 border border-blue-500/40 py-2 pl-4 pr-3 text-xs font-bold uppercase tracking-wider text-blue-300 transition-colors hover:bg-blue-500/30 cursor-pointer"
                >
                  👤 Citizen Mode
                  <span className="grid h-5 w-5 place-items-center rounded-full bg-white/15 transition-transform group-hover:translate-x-0.5">
                    <ArrowUpRight className="h-3 w-3" />
