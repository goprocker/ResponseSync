  ...
  return (
    <header className="bg-[#040806] border-b border-[#10b98125] sticky top-0 z-40 backdrop-blur-md px-4 sm:px-6 py-2.5 shadow-none">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-1 bg-[#040806] p-1 rounded-none border border-[#10b98125]">
          ...
          <button
            ...
            className={`px-2 py-1 rounded-none text-[10px] font-mono font-bold uppercase transition-all cursor-pointer ${
              activePreset === 'normal'
                ...
                : 'text-[#10b981]/60 hover:text-emerald-400'
            }`}
          ...
          <button
            ...
            className={`px-2 py-1 rounded-none text-[10px] font-mono font-bold uppercase transition-all cursor-pointer ${
              activePreset === 'moderate'
                ...
                : 'text-[#10b981]/60 hover:text-amber-400'
            }`}
          ...
          <button
            ...
            className={`px-2 py-1 rounded-none text-[10px] font-mono font-bold uppercase transition-all cursor-pointer ${
              activePreset === 'flood'
                ...
                : 'text-[#10b981]/60 hover:text-red-400'
            }`}
