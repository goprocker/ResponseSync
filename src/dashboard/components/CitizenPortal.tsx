  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-6 space-y-6 text-[#e0e0e6] font-sans">
      ...
      <div className="bg-[#040806] p-6 rounded-none border border-[#10b98125] shadow-none flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        ...
        <a
          href="tel:1070"
          className="flex items-center gap-2 px-5 py-2.5 bg-[#10b981] hover:bg-[#0fa06e] text-black font-bold uppercase tracking-wider rounded shadow-lg shadow-none transition-all text-xs shrink-0 cursor-pointer"
        >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-6 bg-[#040806] rounded-none border border-[#10b98125] p-5 shadow-none space-y-4">
          ...
          <div className="space-y-3 bg-[#040806] p-4 rounded border border-[#10b98115] text-xs">
            <div>
              <label className="text-[#888] font-mono uppercase text-[10px] block mb-1">Your Current Location:</label>
              <div className="flex items-center gap-2 bg-[#040806] px-3 py-2 rounded border border-[#10b98125] text-[#ccc] font-medium font-sans">
                <MapPin className="w-4 h-4 text-emerald-100 shrink-0" />
            ...
            <div>
              ...
              <select
                ...
                className="w-full bg-[#040806] border border-[#10b98125] text-xs text-emerald-100 font-mono font-bold rounded p-2 focus:outline-none"
              >
          ...
          {evacuationRoute ? (
            <div className="bg-[#040806] border-l-4 border-emerald-500 border-t border-b border-r border-[#10b98115] p-4 rounded space-y-3">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <h4 className="text-sm font-bold text-emerald-100 mt-1">
              ...
              <div className="flex justify-between text-xs font-mono bg-[#040806] p-2.5 rounded border border-[#10b98115]">
                <span>Distance: <strong className="text-emerald-100">{evacuationRoute.distanceKm} km</strong></span>
                <span>Est. Time: <strong className="text-emerald-100">{evacuationRoute.estimatedTimeMinutes} Mins</strong></span>
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <ol className="list-decimal list-inside text-xs text-[#ccc] space-y-1 font-mono">
                  {evacuationRoute.turnByTurnInstructions.map((step, idx) => (
                    <li key={idx} className="bg-[#040806] p-2 rounded border border-[#10b98115]">
                      {step}
                    </li>
                  ))}
                </ol>
              ...
              <div className="text-[11px] font-mono text-emerald-100 bg-[#10b981]/10 p-2 rounded border border-[#10b981]/30">
        ...
        <div className="lg:col-span-6 bg-[#040806] rounded-none border border-[#10b98125] p-5 shadow-none space-y-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-3 text-xs">
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-[#040806] border border-[#10b98125] text-[#ccc] rounded p-2 focus:outline-none focus:border-[#10b981]"
                />
              </div>
              <div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <select
                  ...
                  className="w-full bg-[#040806] border border-[#10b98125] text-[#ccc] rounded p-2 focus:outline-none"
                >
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full bg-[#040806] border border-[#10b98125] text-[#ccc] rounded p-2 focus:outline-none font-mono text-emerald-100 font-bold"
                >
            ...
            <button
              ...
              className="w-full py-2.5 bg-[#10b981] hover:bg-[#0fa06e] text-black font-bold uppercase tracking-wider text-xs rounded shadow-lg shadow-none transition-all flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50"
            >
          ...
          {submissionFeedback && (
            <div className="bg-[#040806] border-l-4 border-emerald-500 border-t border-b border-r border-[#10b98115] p-3 rounded text-xs space-y-1">
              <div className="flex items-center justify-between">
      ...
      <div className="bg-[#040806] rounded-none border border-[#10b98125] p-5 shadow-none space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {shelters.map((shelter) => {
            return (
              <div key={shelter.id} className="bg-[#040806] p-4 rounded border border-[#10b98115] space-y-3">
                <div className="flex items-start justify-between">
                  <div>
                    <span className="text-[10px] font-mono font-bold uppercase text-emerald-400 bg-emerald-500/15 px-2 py-0.5 rounded border border-emerald-500/30">
                      {shelter.status.toUpperCase()}
                    </span>
                    <h4 className="font-bold text-emerald-100 text-sm mt-1 font-sans">{shelter.name}</h4>
                  </div>
                </div>
                ...
                <div className="space-y-1 text-xs font-mono">
                  ...
                  <div className="w-full bg-[#040806] h-1.5 rounded overflow-hidden">
                    <div className="bg-[#10b981] h-full" style={{ width: `${(shelter.currentOccupancy / shelter.totalCapacity) * 100}%` }}></div>
                  </div>
                </div>

                <div className="grid grid-cols-2 gap-2 text-[11px] pt-1 border-t border-[#10b98115] font-mono">
                  <span className="text-[#888]">Rations: <strong className="text-emerald-400">{shelter.foodSuppliesDays} Days</strong></span>
                  <span className="text-[#888]">Medical: <strong className="text-emerald-100">{shelter.medicalStaffPresent ? 'Present' : 'On Call'}</strong></span>
                </div>

                <a
                  href={`tel:${shelter.phone}`}
                  className="w-full py-1.5 bg-transparent hover:bg-[#ffffff08] text-[#ccc] border border-[#10b98125] rounded text-xs font-mono font-bold uppercase flex items-center justify-center gap-1.5 transition-all"
                >
