    ...
    <div className="space-y-6 text-[#e0e0e6] font-sans pb-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
        ...
        <div 
          ...
          className="bg-[#0e0e14] border border-white/10 hover:border-red-500/50 p-4 flex items-center justify-between shadow-sm cursor-pointer transition-all hover:bg-white/5 group relative overflow-hidden"
          title="Click to view Active Incidents"
        >
          <div className="space-y-1">
            <div className="flex items-center gap-1.5">
              <span className="text-[10px] uppercase font-mono tracking-wider text-neutral-400 group-hover:text-red-400 transition-colors">Active Incidents</span>
          ...
          <div className="w-10 h-10 rounded-sm bg-red-500/10 border border-red-500/20 flex items-center justify-center text-red-500 group-hover:scale-110 transition-transform">
        ...
        <div 
          ...
          className="bg-[#0e0e14] border border-white/10 hover:border-brand/50 p-4 flex items-center justify-between shadow-sm cursor-pointer transition-all hover:bg-white/5 group relative overflow-hidden"
          title="Click to view Fleet Operations"
        >
          <div className="space-y-1">
            <div className="flex items-center gap-1.5">
              <span className="text-[10px] uppercase font-mono tracking-wider text-neutral-400 group-hover:text-brand transition-colors">Resources Deployed</span>
          ...
          <div className="w-10 h-10 rounded-sm bg-brand/10 border border-brand/20 flex items-center justify-center text-brand group-hover:scale-110 transition-transform">
        ...
        <div 
          ...
          className="bg-[#0e0e14] border border-white/10 hover:border-blue-500/50 p-4 flex items-center justify-between shadow-sm cursor-pointer transition-all hover:bg-white/5 group relative overflow-hidden"
          title="Click to view Emergency Shelters"
        >
          <div className="space-y-1">
            <div className="flex items-center gap-1.5">
              <span className="text-[10px] uppercase font-mono tracking-wider text-neutral-400 group-hover:text-blue-400 transition-colors">Open Shelters</span>
          ...
          <div className="w-10 h-10 rounded-sm bg-blue-500/10 border border-blue-500/20 flex items-center justify-center text-blue-400 group-hover:scale-110 transition-transform">
        ...
        <div 
          ...
          className="bg-[#0e0e14] border border-white/10 hover:border-emerald-500/50 p-4 flex items-center justify-between shadow-sm cursor-pointer transition-all hover:bg-white/5 group relative overflow-hidden"
          title="Click to view Emergency Hospitals"
        >
          <div className="space-y-1">
            <div className="flex items-center gap-1.5">
              <span className="text-[10px] uppercase font-mono tracking-wider text-neutral-400 group-hover:text-emerald-400 transition-colors">Hospitals Online</span>
          ...
          <div className="w-10 h-10 rounded-sm bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center text-emerald-400 group-hover:scale-110 transition-transform">
        ...
        <div 
          ...
          className="bg-[#0e0e14] border border-white/10 hover:border-purple-500/50 p-4 flex items-center justify-between shadow-sm cursor-pointer transition-all hover:bg-white/5 group relative overflow-hidden"
          title="Click to view Digital Twin Weather & IoT Sensors"
        >
          <div className="space-y-1">
            <div className="flex items-center gap-1.5">
              <span className="text-[10px] uppercase font-mono tracking-wider text-neutral-400 group-hover:text-purple-400 transition-colors">Rainfall (24h)</span>
              <span className="w-1.5 h-1.5 rounded-full bg-purple-400 animate-ping"></span>
            </div>
            <div className="text-2xl font-bold text-white font-mono">{currentRainfall} mm</div>
            <div className="text-[10px] text-purple-400 font-mono flex items-center gap-1">
              <span className="w-1.5 h-1.5 rounded-full bg-purple-400 animate-pulse"></span>
              {rainfallRiskText}
            </div>
          </div>
          <div className="w-10 h-10 rounded-sm bg-purple-500/10 border border-purple-500/20 flex items-center justify-center text-purple-400 group-hover:scale-110 transition-transform">
